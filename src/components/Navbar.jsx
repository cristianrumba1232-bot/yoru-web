    ...
    <nav ref={navRef}>
      ...
      <div className="nav-actions">
        <div className="nav-social">
          ...
          <a href="#" className="nav-social-link" aria-label="Facebook" target="_blank" rel="noreferrer">
            <IconFB />
          </a>
          <a href="#" className="nav-social-link" aria-label="LinkedIn" target="_blank" rel="noreferrer">
            <IconLKD />
          </a>
        </div>
        <span className="nav-btn nav-btn--delivery" title="Próximamente">Delivery</span>
        <button type="button" className="nav-btn nav-btn--reservas" onClick={onOpenReservas}>
          Reservas
        </button>
      </div>
    </nav>
