...
export default function Historia() {
  return (
    <div className="page historia-page">
      ...
      {/* ── CONCEPTO ── */}
      <section className="historia-seccion historia-seccion--concepto">
      ...
      {/* ── LA FUSIÓN ── */}
      <section className="historia-seccion historia-seccion--fusion">
      ...
      {/* ── PERSONALIDAD ── */}
      <section className="historia-seccion historia-seccion--keywords">
        <div className="historia-inner historia-inner--center">
      ...
      {/* ── QUOTE ── */}
      <section className="historia-seccion historia-seccion--quote">
        <div className="historia-inner historia-inner--center">
